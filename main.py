...
app.title("Employee Mahagment System")
...
def add_to_treeview():
    employess = database.fetch_employees()
...
def delete():
    ...
    if not selected_item:
        ...
        add_to_treeview()
        clear()
        messagebox.showinfo("Success", "Data has benn deleted.")
...
id_entry = customtkinter.CTkEntry(app, font=font1, text_color= "#000", bg_color="#161C25", border_color = "#0C9295", border_width = 2, width = 180)
id_entry.place(x=100, y=20)

name_label = customtkinter.CTkLabel(app, font=font1, text = "Name:", text_color= "#fff", bg_color="#161C25")
name_label.place(x=20, y=80)

name_entry = customtkinter.CTkEntry(app, font=font1, text_color= "#000", bg_color="#161C25", border_color = "#0C9295", border_width = 2, width = 180)
...
role_entry = customtkinter.CTkEntry(app, font=font1, text_color= "#000", bg_color="#161C25", border_color = "#0C9295", border_width = 2, width = 180)
...
status_entry = customtkinter.CTkEntry(app, font=font1, text_color= "#000", bg_color="#161C25", border_color = "#0C9295", border_width = 2, width = 180)
...
clear_button = customtkinter.CTkButton(app, command = lambda:clear(True) , font = font1, text_color="#fff", text = "Clear Employee", fg_color= "#05A312", hover_color= "#00850B", bg_color="#161C25", cursor ="hand2", corner_radius=15, width=260)
...
delete_update = customtkinter.CTkButton(app, command = delete, font = font1, text_color="#fff", text = "Delete Employee", fg_color= "#05A312", hover_color= "#00850B", bg_color="#161C25", cursor ="hand2", corner_radius=15, width=260)
delete_update.place(x=580, y=360)
